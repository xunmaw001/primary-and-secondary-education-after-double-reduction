    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="线下活动名称" prop="huodongName">
                       <el-input v-model="ruleForm.huodongName"
                                 placeholder="线下活动名称" clearable  :readonly="ro.huodongName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="线下活动名称" prop="huodongName">
                           <el-input v-model="ruleForm.huodongName"
                                     placeholder="线下活动名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.huodongPhoto" label="线下活动照片" prop="huodongPhoto">
                        <file-upload
                            tip="点击上传线下活动照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.huodongPhoto" label="线下活动照片" prop="huodongPhoto">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="线下活动类型" prop="huodongTypes">
                        <el-select v-model="ruleForm.huodongTypes" :disabled="ro.huodongTypes" placeholder="请选择线下活动类型">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="线下活动类型" prop="huodongValue">
                        <el-input v-model="ruleForm.huodongValue"
                            placeholder="线下活动类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="线下活动介绍" prop="huodongContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.huodongContent" label="线下活动介绍" prop="huodongContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   huodongName: [
                              { required: true, message: '线下活动名称不能为空', trigger: 'blur' },
                          ],
                   huodongPhoto: [
                              { required: true, message: '线下活动照片不能为空', trigger: 'blur' },
                          ],
                   huodongTypes: [
                              { required: true, message: '线下活动类型不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   huodongContent: [
                              { required: true, message: '线下活动介绍不能为空', trigger: 'blur' },
                          ],
                   shangxiaTypes: [
