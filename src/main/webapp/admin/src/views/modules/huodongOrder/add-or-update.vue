        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='huodong'">
                    <el-form-item class="select" v-if="type!='info'"  label="线下活动" prop="huodongId">
                        <el-select v-model="ruleForm.huodongId" :disabled="ro.huodongId" filterable placeholder="请选择线下活动" @change="huodongChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="线下活动名称" prop="huodongName">
                        <el-input v-model="huodongForm.huodongName"
                                  placeholder="线下活动名称" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='huodong' ">
                    <el-form-item class="input" v-if="type!='info'"  label="线下活动类型" prop="huodongValue">
                        <el-input v-model="huodongForm.huodongValue"
                                  placeholder="线下活动类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   huodongId: [
                              { required: true, message: '线下活动不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
